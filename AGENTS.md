...
# Purpose
This repository is dedicated to the development and maintenance of Field Fence Estimator. This file provides reusable, repo-level instructions to AI coding agents to ensure predictable, clean, and safe development.
